...
> 🚨 We strongly advise that you do not run Easy Setup on a production environment. It will make irreversible changes and may delete some previous configurations on your store. This options is for have a test environment with data

## Installation

NOTE: Only for POCs and testing purposes. Do not use this theme in production, for production use the [B2B Store Theme ITG](https://github.com/ITGlobers/init-b2b-itg) or this repository.
...
[B2B Store Theme](https://github.com/vtex-apps/b2b-newstore-theme), repository on GitHub, for guide on how to customize the theme.

After following the steps above, you are ready to install the [B2B Suite](https://developers.vtex.com/vtex-developer-docs/docs/vtex-b2b-suite).

# Standard ITG

For the folder creation and naming guide we will use the same documentation as the current standard for B2C. [Docs](https://github.com/ITGlobers/ITG-init)
